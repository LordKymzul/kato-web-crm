...
import { applicationsData, chartConfig } from '../data/manager-stats-data';
            ...
            <CardHeader className="pb-3">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2">
                    <div className="min-w-0 flex-1">
                        <CardTitle className="text-base sm:text-lg font-bold">Applications</CardTitle>
                        <CardDescription className="text-xs sm:text-sm text-muted-foreground">
                            Application approval and decline statistics
                        </CardDescription>
                    </div>
