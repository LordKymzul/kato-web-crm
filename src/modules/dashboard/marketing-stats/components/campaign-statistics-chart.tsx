...
import { campaignStatisticsData, marketingChartConfig } from '../data/marketing-stats-data';
...
export function CampaignStatisticsChart() {
        ...
        <Card className="w-full">
            <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
                    <CardTitle>Statistics By Campaigns</CardTitle>
                    <CardDescription>
                        Performance metrics by marketing campaign
                    </CardDescription>
                </div>
                <div className="flex">
                    <DropdownMenu>
...
export default CampaignStatisticsChart;
