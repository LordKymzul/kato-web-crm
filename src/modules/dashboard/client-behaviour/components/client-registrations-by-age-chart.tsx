...
import { registrationsByAgeData, chartConfig } from '../data/client-behavior-data';

// Use imported data
const ageData = registrationsByAgeData;
...
export function ClientRegistrationsByAgeChart() {
            ...
            <CardHeader className="pb-3">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-2">
                    <div className="min-w-0 flex-1">
                        <CardTitle className="text-base sm:text-lg font-bold">Registrations, first deposits, opened accounts by Age</CardTitle>
                        <CardDescription className="text-xs sm:text-sm text-muted-foreground">
                            Distribution of client registrations and activity across age groups
                        </CardDescription>
                    </div>
...
export default ClientRegistrationsByAgeChart;
