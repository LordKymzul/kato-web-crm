...
import { Plus, Search, SortAsc, MoreHorizontal, Check, Loader2, Columns } from "lucide-react"
...
const DefaultTable = ({
    ...
    const visibleColumnsData = columns.filter(col => visibleColumns.includes(col.accessorKey))
                                    ...
                                    <DropdownMenuContent align="end" className="w-48">
                                        {columns.map((column) => (
                                            <DropdownMenuCheckboxItem
                                                ...
                                                onCheckedChange={() => handleColumnVisibilityChange(column.accessorKey)}
                                            >
                                                {column.header}
                                            </DropdownMenuCheckboxItem>
                                        ))}
